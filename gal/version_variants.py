...
class V6_0812A(VersionVariant):
	def __init__(self, version=6, variant='0812A', params=None, **kwargs):
		...
		self.params.update({'rd_cutoff': 0.4, 'diverse_answer_queries': True,
			'delta_link_threshold_factor': 1.3, 'dynamic_grade_weights': False,
			'grade_assignment_method': 'parent_breaks'})

class V6_0812A_se(V6_0812A):
	def __init__(self, version=6, variant='0812A_se', params=None, **kwargs):
		V6_0812A.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'entropy_calculation_method': 'simple'})
...
class V6_0812C(VersionVariant):
	def __init__(self, version=6, variant='0812C', params=None, **kwargs):
		...
		self.params.update({'rd_cutoff': 0.4, 'diverse_answer_queries': False,
			'delta_link_threshold_factor': 1.3, 'dynamic_grade_weights': True,
			'grade_assignment_method': 'parent_breaks'})
...
class V6_0812H(V6_0812G):
	def __init(self, version=6, variant='0812H', params=None, **kwargs):
		V6_0812G.__init__(self, version=version, variant=variant, params=params, **kwargs)
...
class V6_0825B(VersionVariant):
	def __init__(self, version=6, variant='0825B', params=None, **kwargs):
		VersionVariant.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'rd_cutoff': 0.4, 'grade_assignment_method': 'parent_breaks',
			'diverse_answer_queries': True, 'diverse_answer_queries_all': False,
			'dynamic_grade_weights': True})
...
class V6_0825D1_eqw_se(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0825D1_eqw_se', params=None, **kwargs):
...
class V6_0309A1(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309A1', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'rd_cutoff_adjustment_factor': 1.1})

class V6_0309A1_se(V6_0825D1_eqw_se):
	def __init__(self, version=6, variant='0309A1_se', params=None, **kwargs):
		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'rd_cutoff_adjustment_factor': 1.1})

class V6_0309A2(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309A2', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'rd_cutoff_adjustment_factor': 0.9})

class V6_0309A2_se(V6_0825D1_eqw_se):
	def __init__(self, version=6, variant='0309A2_se', params=None, **kwargs):
		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'rd_cutoff_adjustment_factor': 0.9})

class V6_0309B1(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309B1', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'grade_assignment_method': 'parent'})

class V6_0309B1_se(V6_0825D1_eqw_se):
	def __init__(self, version=6, variant='0309B1_se', params=None, **kwargs):
		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'grade_assignment_method': 'parent'})

class V6_0309B2(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309B2', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'delta_link_threshold_adjustment_factor': 1.1})

class V6_0309B2_se(V6_0825D1_eqw_se):
	def __init__(self, version=6, variant='0309B2_se', params=None, **kwargs):
		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'delta_link_threshold_adjustment_factor': 1.1})

class V6_0309B3(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309B3', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'delta_link_threshold_adjustment_factor': 1.2})

class V6_0309B3_se(V6_0825D1_eqw_se):
	def __init__(self, version=6, variant='0309B3_se', params=None, **kwargs):
		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'delta_link_threshold_adjustment_factor': 1.2})

# class V6_0309C1(V6_0825D1_eqw):
# 	def __init__(self, version=6, variant='0309C1', params=None, **kwargs):
# 		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
# 		self.params.update({'density_log_base': 2})

# class V6_0309C1_se(V6_0825D1_eqw_se):
# 	def __init__(self, version=6, variant='0309C1_se', params=None, **kwargs):
# 		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
# 		self.params.update({'density_log_base': 2})

# class V6_0309C2(V6_0825D1_eqw):
# 	def __init__(self, version=6, variant='0309C2', params=None, **kwargs):
# 		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
# 		self.params.update({'density_log_base': 4})

# class V6_0309C2_se(V6_0825D1_eqw_se):
# 	def __init__(self, version=6, variant='0309C2_se', params=None, **kwargs):
# 		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
# 		self.params.update({'density_log_base': 4})
...
class V6_0309C1(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309C1', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'entropy_density_weighting_method': 1})
...
class V6_0309C2(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309C2', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'entropy_density_weighting_method': 2})
...
class V6_0309C3(V6_0825D1_eqw):
	def __init__(self, version=6, variant='0309C2', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'entropy_density_weighting_method': 3})

class V6_0309C3_se(V6_0825D1_eqw_se):
	def __init__(self, version=6, variant='0309C2_se', params=None, **kwargs):
		V6_0825D1_eqw_se.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'entropy_density_weighting_method': 3})

def calculate_possible_grade_weights(possible_grades, minimum_at_center=True):
	# possible_grades_weights = [1.2, 0.6, 1.2] if len(possible_grades) == 3 else [1/3, 1/6, 1/6, 1/3]
	length = len(possible_grades)
	is_even = (length % 2 == 0)
	num_level = int(length/ 2) + int(not is_even)
	num_division = sum([i * 2 for i in range(1, num_level + 1)]) - int(not is_even)
	if minimum_at_center:
		levels = [num_level - i if i < num_level else i - num_level + 1 + int(not is_even) \
			for i in range(length)]
	else:
		levels = [i + 1 if i < num_level else len(possible_grades) - i for i in range(length)]
	return [length * level / num_division for level in levels]
...
class V6_0915B(V6_0825D):
	def __init__(self, version=6, variant='0915B', params=None, **kwargs):
		...
		possible_grades_weights = calculate_possible_grade_weights(params.get('possible_grades'),
			minimum_at_center=True)
		self.params.update({'dynamic_grade_weights': False, 'possible_grades_weights': possible_grades_weights,
			'weighted_global_entropy': True, 'weighted_label_assignment': True})
...
class V6_RandomGrading(V6_0825D1_eqw):
	def __init__(self, version=6, variant='RandomGrading', params=None, **kwargs):
		V6_0825D1_eqw.__init__(self, version=version, variant=variant, params=params, **kwargs)
		self.params.update({'random_answer_selection': True})
